...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http
                ...
                .requestMatchers("/", "/sign", "/index", "/searchresults", "/api/packages", "/signup", "/contact", "/faq", "/plugins/**", "/assets/**", "/images/**", "/403").permitAll()
    ...
    /**
     * Determines the users Authority and handles the actual redirect
     *
     * @param request
     * @param response
    ...
    /**
     * Redirects home page depending on the user Tag logging in
     *
     * @param authorities
     * @return
     */
    ...
    /**
     * Calls password encoder for the new user signing up
     *
     * @param auth
     * @throws Exception
     */
